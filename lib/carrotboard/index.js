...
const { Client, MessageReaction, TextChannel, MessageEmbed, MessageEmbedOptions, Channel, User, Message } = require("discord.js");
...
class CarrotboardStorage {
    ...
    async updateLeaderboard() {
        const embedPages = await this.generateLeaderboard({ onlyFirstPage: true, emoji: this.config.carrot });
    ...
    async generateLeaderboard({onlyFirstPage=false, userID=null, emoji=null}) {
        ...
        let entries = [];
        if (userID != null) {
            entries = await this.db.get_all_by_user(this.config.carrot, this.config.minimum, userID);
        } else if (emoji != null) {
        ...
        for (const entry of entries) {
            ...
            let content = entry["message_contents"];
...
class CarrotboardConfig {
    ...
    saveToFile() {
        const yamlStr = YAML.stringify({
            "leaderboard_message_id": Number(this.leaderboardID),
            "leaderboard_channel_id": Number(this.permaChannelID),
            "carrotboard_alert_channel_id": Number(this.alertChannelID),
            "guild_id": Number(this.guildID),
    ...
    set leaderboardID(value) {
        if (typeof(value) != "string" && typeof(value) != "number") {
            throw new TypeError(`Carrotboard: leaderboardID must be type String | Number`);
        }
    ...
    set permaChannelID(value) {
        if (typeof(value) != "string" && typeof(value) != "number") {
            throw new TypeError(`Carrotboard: permaChannelID must be type String | Number`);
        }
    ...
    set alertChannelID(value) {
        if (typeof(value) != "string" && typeof(value) != "number") {
            throw new TypeError(`Carrotboard: alertChannelID must be type String | Number`);
        }
    ...
    set guildID(value) {
        if (typeof(value) != "string" && typeof(value) != "number") {
            throw new TypeError(`Carrotboard: guildID must be type String | Number`);
        }
    ...
    set minimum(value) {
        if (typeof(value) != "number") {
            throw new TypeError(`Carrotboard: minimum must be type Number`);
        }
    ...
    set pinMinimum(value) {
        if (typeof(value) != "number") {
            throw new TypeError(`Carrotboard: pinMinimum must be type Number`);
        }
