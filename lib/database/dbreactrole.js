...
class DBReactRole {
    ...
    async add_react_role_role(role_id, emoji, msg_id) {
        ...
        try {
            ...
            const query = "INSERT INTO react_role_roles VALUES ($1,$2,$3)";
    ...
    async get_roles(msg_id, emoji) {
        ...
        try {
            ...
            const result = await client.query(
                "select * from react_role_roles where msg_id=$1 and emoji=$2",
                values,
            );
            await client.query("COMMIT");
    ...
    async get_sender(msg_id) {
        ...
        try {
            ...
            const values = [msg_id];
            const result = await client.query(
                "select * from react_role_msgs where msg_id=$1",
                values,
            );
            await client.query("COMMIT");
