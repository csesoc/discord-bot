...
class DBstandup {
    ...
    async addStandup(channelParentId, userId, messageId, messageContent) {
        ...
        try {
            ...
            var result = await client.query(queryInsertStandup, values_params)
            await client.query("COMMIT");
    ...
    async thisStandupExists(messageId) {
        ...
        try {
            ...
            `;
            var result = await client.query(query, [messageId]);
