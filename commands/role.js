...
module.exports = {
  ...
  async execute(interaction) {
    try {
      var reg_comp_course = /^comp\d{4}$/;
      var reg_math_course = /^math\d{4}$/;
      var reg_binf_course = /^binf\d{4}$/;
      var reg_engg_course = /^engg\d{4}$/;
      var reg_seng_course = /^seng\d{4}$/;
      var reg_desn_course = /^desn\d{4}$/;
