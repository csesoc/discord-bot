...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const data = [message_id, channel_obj.id, datetime, user_reminder];
        ...
        let reply_msg = `Message # ${message_id} for channel '${channel_name}' schedule at ${datetime} which is in ${send_in}.`;
        const num_msg_attachments = message.attachments.size;

        if (num_msg_attachments) {
            reply_msg += ` This message has ${num_msg_attachments} attachment${
