...
module.exports = {
    ...
    async execute(member) {
        ...
        await fsLibrary.writeFile(
            "members_remove_log.txt",
            "Logs members that have left in the CSE discord channel",
            (error) => {
        ...
        const log = `${Date.now()} - ${member.id} left the guild ${Guild.name}`;
